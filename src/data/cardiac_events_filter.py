...
def analyze_cardiac_arrest_events(conn, eArrest_codes_01, eArrest_codes_02, eArrest_codes_03, eResponse_codes, eDisposition_codes):
    ...
    query = """ SELECT 
                    ...
                    T1.eArrest_05,                  -- CPR Prior to EMS Arrival
                    T1.eArrest_11,                  -- Shockable Initial Rhythm
                    T1.eOutcome_01,                 -- End of Event Outcome
                    T1.eOutcome_02,                 -- End of Event Outcome
                    T1.ePatient_13,                 -- Gender of Patient
                    T1.eResponse_15,                -- Basic (BLS) or Advanced Life Support (ALS)
                    T1.eScene_09,                   -- Patient Intercept in Public Setting?
                    T1.eArrest_02,                  -- Injury Reported
                    T1.eResponse_05,                -- Not a 911 Scene
                    T1.eDisposition_12,             -- Did not Trans or Terminate
                    ...
                    T5.eArrest_12,                  -- ROSC?
                    T6.eArrest_09,                  -- Mechanical CPR given?
                    T7.eArrest_04                   -- Arrest Witnessed by EMS?
                ...
                LEFT JOIN FACTPCRARRESTROSC AS T5 ON T1.PcrKey = T5.PcrKey 
                LEFT JOIN FACTPCRARRESTCPRPROVIDED AS T6 ON T1.PcrKey = T6.PcrKey
                LEFT JOIN FACTPCRARRESTWITNESS AS T7 ON T1.PcrKey = T7.PcrKey 
    ...
    cols_to_convert = ['PcrKey', 'eArrest_01', 'eArrest_02', 'eResponse_05', 'eDisposition_12', 'eArrest_03',
       'ageinyear', 'EMSSystemResponseTimeMin', 'eArrest_12', 'eArrest_09', 'eArrest_04',
       'eArrest_05', 'eArrest_11', 'eOutcome_01', 'eOutcome_02', 'ePatient_13', 'eResponse_15', 'eScene_09']
...
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..")) 
file_path = os.path.join(project_root, "data", "interim", "filtered_cardiac_events_df.pkl")
